...
START_DIR                 = /home/aman/GitHub/flightTestingLab/controls/Ingenuity_Modelling/MATLAB-env
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MARS
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/MARS_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
%.o : $(START_DIR)/MARS_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/MARS_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
